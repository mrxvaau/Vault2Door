...
namespace Vault2Door
{
    public partial class Form1 : Form
    {
        private void BuildDashboardUI()
        {
            ...
            var rightBar = new FlowLayoutPanel { Dock = DockStyle.Right, Width = 220, FlowDirection = FlowDirection.RightToLeft, WrapContents = false, Padding = new Padding(0, 10, 12, 0), BackColor = Color.Transparent };
            ...
            bannerText = new Label
            {
                ...
                ForeColor = Color.White, Font = new Font("Segoe UI", 10), AutoSize = true, Location = new Point(10, 12)
            };
            ...
            // Metrics table (single line, equal cells)
            ...
            for (int i = 0; i < 4; i++)
            {
                var card = new Panel { Dock = DockStyle.Fill, BackColor = Color.White, BorderStyle = BorderStyle.FixedSingle, Margin = new Padding(18, 0, 18, 0) };
                var l = new Label { Text = metrics[i], Location = new Point(10, 10), Size = new Size(1000, 70) };
                card.Controls.Add(l);
                metricsTable.Controls.Add(card, i, 0);
            }

            // Assets title (positioned later by AlignVerticalLayout)
            ...
            // Content row (positioned by AlignVerticalLayout)
