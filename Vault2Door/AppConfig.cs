...
namespace Vault2Door{
  public static class AppConfig{ public static bool UseAlphaVantage=true; public static string AlphaVantageApiKey=""; public const int PollIntervalMs=60000; }
  public static class ConfigService{
    ...
    public static void Load(){ try{ if(File.Exists(FilePath)){ var cfg=JsonSerializer.Deserialize<ConfigModel>(File.ReadAllText(FilePath)); if(cfg!=null) AppConfig.AlphaVantageApiKey=cfg.AlphaVantageApiKey??""; } }catch{} }
